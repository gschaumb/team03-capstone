...
- The fact that we (for project efficiency's sake) used GPT-4o responses as our Ground Truth may have contributed to the Unaugmented Reponse being rated best, as the common model training between GPT-4o and GPT-3.5-Turbo can be considered a form of data leakage potentially favoring the non-RAG responses.
